...
export interface PrismaClientConstructor {
   ...
   * // Fetch zero or more TranscriptSessions
...
/**
  ...
  $extends: runtime.Types.Extensions.ExtendsHook<"extends", Prisma.TypeMapCb<ClientOptions>, ExtArgs, runtime.Types.Utils.Call<Prisma.TypeMapCb<ClientOptions>, {
    extArgs: ExtArgs
      ...
      /**
   * `prisma.transcriptSession`: Exposes CRUD operations for the **TranscriptSession** model.
    * Example usage:
    * ```ts
    * // Fetch zero or more TranscriptSessions
    * const transcriptSessions = await prisma.transcriptSession.findMany()
    * ```
    */
  get transcriptSession(): Prisma.TranscriptSessionDelegate<ExtArgs, ClientOptions>;

  /**
   * `prisma.convAIAgent`: Exposes CRUD operations for the **ConvAIAgent** model.
    * Example usage:
    * ```ts
    * // Fetch zero or more ConvAIAgents
    * const convAIAgents = await prisma.convAIAgent.findMany()
    * ```
    */
  get convAIAgent(): Prisma.ConvAIAgentDelegate<ExtArgs, ClientOptions>;
